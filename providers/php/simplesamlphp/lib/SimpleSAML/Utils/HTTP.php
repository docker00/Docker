...
class HTTP
{
    ...
    {
        if (array_key_exists('HTTP_X_DATA_HOST', $_SERVER)) {
            $current = $_SERVER['HTTP_X_DATA_HOST'];
    ...
    private static function getServerPort()
    {
        ...
        $port = (isset($_SERVER['HTTP_X_DATA_SERVER_PORT'])) ? $_SERVER['HTTP_X_DATA_SERVER_PORT'] : $port;
    ...
    public static function getBaseURL()
    {
        ...
        if (preg_match('#^https?://.*/$#D', $baseURL, $matches)) {
            ...
            $path = $_SERVER['HTTP_X_DATA_REDIRECT_LOCATION'].'/'.$globalConfig->getBaseURL();
    ...
    public static function getSelfURL()
    {
        ...
        if ($cur_path == $rel_path || $uri_pos === false) {
            ...
            $hostname = self::getServerHost();
            $port = self::getServerPort();
            return $protocol.$hostname.$port.$_SERVER['HTTP_X_DATA_REDIRECT_LOCATION'].$_SERVER['REQUEST_URI'];
        }
