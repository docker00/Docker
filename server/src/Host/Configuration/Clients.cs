...
namespace Host.Configuration
{
    ...
    {
        public static IEnumerable<Client> Get(string connectionString, bool fromDataBase)
        {
            if (fromDataBase)
            {
                ClientCustomStore clientCustomRepositoryStore = new ClientCustomStore(connectionString);
                return clientCustomRepositoryStore.ClientCustoms;
            }
            else
            {
                return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    RedirectUris = { "http://localhost/php_provider/client_example.php",
                                     "http://localhost/php_provider/page2.php",
                                     "http://localhost/php_provider/page3.php",
                                     "http://localhost/simplesaml/module.php/openidconnect/resume.php" },
                    PostLogoutRedirectUris = { "http://192.168.0.51:21402/signout-callback-oidc" },
